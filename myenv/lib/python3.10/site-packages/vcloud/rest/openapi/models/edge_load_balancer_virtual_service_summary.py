...
class EdgeLoadBalancerVirtualServiceSummary(object):
    """
    ...
    def __init__(self, status=None, id=None, name=None, description=None, enabled=None, virtual_ip_address=None, load_balancer_pool_ref=None, gateway_ref=None, service_engine_group_ref=None, certificate_ref=None, service_ports=None, health_status=None, health_message=None, detailed_health_message=None, application_profile_type=None):
        """
        EdgeLoadBalancerVirtualServiceSummary - a model defined in Swagger
        """
        ...
        self._application_profile_type = None
        ...
        if application_profile_type is not None:
          self.application_profile_type = application_profile_type

    @property
    def status(self):
        """
        Gets the status of this EdgeLoadBalancerVirtualServiceSummary.
        Represents current status of the networking object. 

        :return: The status of this EdgeLoadBalancerVirtualServiceSummary.
    ...
    def status(self, status):
        """
        Sets the status of this EdgeLoadBalancerVirtualServiceSummary.
        Represents current status of the networking object. 

        :param status: The status of this EdgeLoadBalancerVirtualServiceSummary.
    ...
    def id(self):
        """
        Gets the id of this EdgeLoadBalancerVirtualServiceSummary.
        The identifier of the Virtual Service in URN format

        :return: The id of this EdgeLoadBalancerVirtualServiceSummary.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this EdgeLoadBalancerVirtualServiceSummary.
        The identifier of the Virtual Service in URN format

        :param id: The id of this EdgeLoadBalancerVirtualServiceSummary.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this EdgeLoadBalancerVirtualServiceSummary.
        The name of the Virtual Service. Name is unique across all Virtual Services for an Edge Gateway.

        :return: The name of this EdgeLoadBalancerVirtualServiceSummary.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this EdgeLoadBalancerVirtualServiceSummary.
        The name of the Virtual Service. Name is unique across all Virtual Services for an Edge Gateway.

        :param name: The name of this EdgeLoadBalancerVirtualServiceSummary.
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """
        Gets the description of this EdgeLoadBalancerVirtualServiceSummary.
        The description of the Virtual Service.

        :return: The description of this EdgeLoadBalancerVirtualServiceSummary.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this EdgeLoadBalancerVirtualServiceSummary.
        The description of the Virtual Service.

        :param description: The description of this EdgeLoadBalancerVirtualServiceSummary.
        :type: str
        """
    ...
    def enabled(self):
        """
        Gets the enabled of this EdgeLoadBalancerVirtualServiceSummary.
        A flag indicating whether Virtual Service is enabled or not.

        :return: The enabled of this EdgeLoadBalancerVirtualServiceSummary.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """
        Sets the enabled of this EdgeLoadBalancerVirtualServiceSummary.
        A flag indicating whether Virtual Service is enabled or not.

        :param enabled: The enabled of this EdgeLoadBalancerVirtualServiceSummary.
        :type: bool
        """
        if enabled is None:
    ...
    def virtual_ip_address(self):
        """
        Gets the virtual_ip_address of this EdgeLoadBalancerVirtualServiceSummary.
        ...
        :return: The virtual_ip_address of this EdgeLoadBalancerVirtualServiceSummary.
        :rtype: str
        """
    ...
    def virtual_ip_address(self, virtual_ip_address):
        """
        Sets the virtual_ip_address of this EdgeLoadBalancerVirtualServiceSummary.
        The virtual IP Address (VIP) of the Virtual Service. This IP can be an allocated IP to the Gateway from the External Network or it can be an arbitrary internal IP address used for internal load balancing. It it's an internal IP Address, this IP cannot be part of any existing subnet attached to the Edge Gateway or any vDC Group network if the Edge Gateway is scoped accordingly. 

        :param virtual_ip_address: The virtual_ip_address of this EdgeLoadBalancerVirtualServiceSummary.
        :type: str
        """
    ...
    def load_balancer_pool_ref(self):
        """
        Gets the load_balancer_pool_ref of this EdgeLoadBalancerVirtualServiceSummary.
        The Load Balancer Pool associated with this Virtual Service.

        :return: The load_balancer_pool_ref of this EdgeLoadBalancerVirtualServiceSummary.
    ...
    def load_balancer_pool_ref(self, load_balancer_pool_ref):
        """
        Sets the load_balancer_pool_ref of this EdgeLoadBalancerVirtualServiceSummary.
        The Load Balancer Pool associated with this Virtual Service.

        :param load_balancer_pool_ref: The load_balancer_pool_ref of this EdgeLoadBalancerVirtualServiceSummary.
    ...
    def gateway_ref(self):
        """
        Gets the gateway_ref of this EdgeLoadBalancerVirtualServiceSummary.
        The Edge Gateway associated with this Virtual Service.

        :return: The gateway_ref of this EdgeLoadBalancerVirtualServiceSummary.
        :rtype: EntityReference
        """
    ...
    def gateway_ref(self, gateway_ref):
        """
        Sets the gateway_ref of this EdgeLoadBalancerVirtualServiceSummary.
        The Edge Gateway associated with this Virtual Service.

        :param gateway_ref: The gateway_ref of this EdgeLoadBalancerVirtualServiceSummary.
        :type: EntityReference
        """
    ...
    def service_engine_group_ref(self):
        """
        Gets the service_engine_group_ref of this EdgeLoadBalancerVirtualServiceSummary.
        ...
        :return: The service_engine_group_ref of this EdgeLoadBalancerVirtualServiceSummary.
        :rtype: EntityReference
        """
    ...
    def service_engine_group_ref(self, service_engine_group_ref):
        """
        Sets the service_engine_group_ref of this EdgeLoadBalancerVirtualServiceSummary.
        The Load Balancer Service Engine Group that is assigned to the Edge Gateway. This Virtual Service will be deployed to this Service Engine Group. 

        :param service_engine_group_ref: The service_engine_group_ref of this EdgeLoadBalancerVirtualServiceSummary.
        :type: EntityReference
        """
    ...
    def certificate_ref(self):
        """
        Gets the certificate_ref of this EdgeLoadBalancerVirtualServiceSummary.
        ...
        :return: The certificate_ref of this EdgeLoadBalancerVirtualServiceSummary.
        :rtype: EntityReference
        """
    ...
    def certificate_ref(self, certificate_ref):
        """
        Sets the certificate_ref of this EdgeLoadBalancerVirtualServiceSummary.
        The certificate used for SSL termination for the Virtual Service. This is required if the service port type is \"HTTPS\" or \"L4_TLS\".

        :param certificate_ref: The certificate_ref of this EdgeLoadBalancerVirtualServiceSummary.
        :type: EntityReference
        """
    ...
    def service_ports(self):
        """
        Gets the service_ports of this EdgeLoadBalancerVirtualServiceSummary.
        ...
        :return: The service_ports of this EdgeLoadBalancerVirtualServiceSummary.
    ...
    def service_ports(self, service_ports):
        """
        Sets the service_ports of this EdgeLoadBalancerVirtualServiceSummary.
        A list of service ports supported by this Virtual Service.  Multiple service ports are allowed only with additional licensing. 

        :param service_ports: The service_ports of this EdgeLoadBalancerVirtualServiceSummary.
    ...
    def health_status(self):
        """
        Gets the health_status of this EdgeLoadBalancerVirtualServiceSummary.
        ...
        :return: The health_status of this EdgeLoadBalancerVirtualServiceSummary.
        :rtype: str
        """
    ...
    def health_status(self, health_status):
        """
        Sets the health_status of this EdgeLoadBalancerVirtualServiceSummary.
        The current health status of the virtual service. Possible values are: <ul> <li> UP - The virtual service is healthy. <li> DOWN - The virtual service is down, inactive, or has failed. <li> DISABLED - The virtual service is disabled. <li> UNAVAILABLE - The virtual service is unavailable. <li> PENDING - The virtual service is being creating or resources are being allocated. <li> UNKNOWN - The virtual service state is unknown. </ul> 

        :param health_status: The health_status of this EdgeLoadBalancerVirtualServiceSummary.
        :type: str
        """
    ...
    def health_message(self):
        """
        Gets the health_message of this EdgeLoadBalancerVirtualServiceSummary.
        The localized message on the health of the virtual service.

        :return: The health_message of this EdgeLoadBalancerVirtualServiceSummary.
        :rtype: str
        """
    ...
    def health_message(self, health_message):
        """
        Sets the health_message of this EdgeLoadBalancerVirtualServiceSummary.
        The localized message on the health of the virtual service.

        :param health_message: The health_message of this EdgeLoadBalancerVirtualServiceSummary.
        :type: str
        """
    ...
    def detailed_health_message(self):
        """
        Gets the detailed_health_message of this EdgeLoadBalancerVirtualServiceSummary.
        The non-localized detailed message on the health of the virtual service.

        :return: The detailed_health_message of this EdgeLoadBalancerVirtualServiceSummary.
        :rtype: str
        """
    ...
    def detailed_health_message(self, detailed_health_message):
        """
        Sets the detailed_health_message of this EdgeLoadBalancerVirtualServiceSummary.
        The non-localized detailed message on the health of the virtual service.

        :param detailed_health_message: The detailed_health_message of this EdgeLoadBalancerVirtualServiceSummary.
        :type: str
        """
    ...
    @property
    def application_profile_type(self):
        """
        Gets the application_profile_type of this EdgeLoadBalancerVirtualServiceSummary.
        ...
        :return: The application_profile_type of this EdgeLoadBalancerVirtualServiceSummary.
        :rtype: str
        """
        return self._application_profile_type

    @application_profile_type.setter
    def application_profile_type(self, application_profile_type):
        """
        Sets the application_profile_type of this EdgeLoadBalancerVirtualServiceSummary.
        The profile type of application that this Virtual Service is configured with. A value of \"-\" represents an unknown type. <ul> <li>HTTP - Virtual Service supports HTTP protocol. <li>HTTPS - Virtual Service supports HTTPS protocol. <li>L4 - Virtual Service supports Layer 4 (Transport) using UDP/TCP protocol. <li>L4_TLS - Virtual Service supports Layer 4 (Transport) using UDP/TCP protocol with TLS. </ul> 

        :param application_profile_type: The application_profile_type of this EdgeLoadBalancerVirtualServiceSummary.
        :type: str
        """

        self._application_profile_type = application_profile_type
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, EdgeLoadBalancerVirtualServiceSummary):
            return False
