...
class EdgeLoadBalancerPersistenceProfile(object):
    """
    ...
    def __init__(self, name=None, type=None, value=None):
        """
        EdgeLoadBalancerPersistenceProfile - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this EdgeLoadBalancerPersistenceProfile.
        Name of the Persistence profile. 

        :return: The name of this EdgeLoadBalancerPersistenceProfile.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this EdgeLoadBalancerPersistenceProfile.
        Name of the Persistence profile. 

        :param name: The name of this EdgeLoadBalancerPersistenceProfile.
        :type: str
        """
    ...
    def type(self):
        """
        Gets the type of this EdgeLoadBalancerPersistenceProfile.
        ...
        :return: The type of this EdgeLoadBalancerPersistenceProfile.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this EdgeLoadBalancerPersistenceProfile.
        Type of persistence strategy to use. Supported values are: <ul> <li>CLIENT_IP - The client’s IP is used as the identifier and mapped to the server. <li>HTTP_COOKIE - Load Balancer inserts a cookie into HTTP responses. Cookie name must be provided as value. <li>CUSTOM_HTTP_HEADER - Custom, static mappings of header values to specific servers are used. Header name must be provided as value. <li>APP_COOKIE - Load Balancer reads existing server cookies or URI embedded data such as JSessionID. Cookie name must be provided as value. <li>TLS - Information is embedded in the client’s SSL/TLS ticket ID. This will use default system profile \"System-Persistence-TLS\". </ul> Using <em>CUSTOM_HTTP_HEADER</em>, <em>APP_COOKIE</em>, <em>TLS</em> persistence types may require additional licensing. 

        :param type: The type of this EdgeLoadBalancerPersistenceProfile.
        :type: str
        """
        if type is None:
    ...
    def value(self):
        """
        Gets the value of this EdgeLoadBalancerPersistenceProfile.
        ...
        :return: The value of this EdgeLoadBalancerPersistenceProfile.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """
        Sets the value of this EdgeLoadBalancerPersistenceProfile.
        Value of attribute based on selected persistence type. This is required for HTTP_COOKIE, CUSTOM_HTTP_HEADER and APP_COOKIE persistence types. HTTP_COOKIE, APP_COOKIE must have cookie name set as the value and CUSTOM_HTTP_HEADER must have header name set as the value. 

        :param value: The value of this EdgeLoadBalancerPersistenceProfile.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, EdgeLoadBalancerPersistenceProfile):
            return False
