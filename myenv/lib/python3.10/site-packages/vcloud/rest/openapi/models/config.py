...
class Config(object):
    ...
    def __init__(self, name=None, typed_value=None):
        """
    ...
    def typed_value(self, typed_value):
        """
        Sets the typed_value of this Config.
        The value of the configuration property (at present all configuration values are treated as the \"string\" type).

        :param typed_value: The typed_value of this Config.
        :type: TypedValue
        """
