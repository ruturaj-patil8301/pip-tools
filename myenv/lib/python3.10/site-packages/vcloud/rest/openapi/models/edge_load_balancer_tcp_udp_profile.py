...
class EdgeLoadBalancerTcpUdpProfile(object):
    """
    ...
    def __init__(self, name=None, type='TCP_PROXY', system_defined=None):
        """
        EdgeLoadBalancerTcpUdpProfile - a model defined in Swagger
        """
    ...
    def name(self, name):
        """
        Sets the name of this EdgeLoadBalancerTcpUdpProfile.
        Name of the TCP/UDP profile. Name of the system defined monitors are prefixed with System for example 'System-TCP-Proxy'.

        :param name: The name of this EdgeLoadBalancerTcpUdpProfile.
        :type: str
        """
    ...
    def type(self):
        """
        Gets the type of this EdgeLoadBalancerTcpUdpProfile.
        ...
        :return: The type of this EdgeLoadBalancerTcpUdpProfile.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this EdgeLoadBalancerTcpUdpProfile.
        This property specifies the different ways in which TCP/UDP packets are sent to the destination server. A value of \"-\" represents an unknown type. Such profile can still be removed from the Virtual Service on update but is not valid on create. <ul> <li>TCP_PROXY - TCP connection is terminated at the Virtual Service and a new TCP connection is made to the destination server. <li>TCP_FAST_PATH - TCP packets are directly forwarded to the destination server. <li>UDP_FAST_PATH - UDP packets are directly forwarded to the destination server. </ul> 

        :param type: The type of this EdgeLoadBalancerTcpUdpProfile.
        :type: str
        """
        if type is None:
    ...
    def system_defined(self):
        """
        Gets the system_defined of this EdgeLoadBalancerTcpUdpProfile.
        Whether the TCP/UDP profile is system defined.

        :return: The system_defined of this EdgeLoadBalancerTcpUdpProfile.
        :rtype: bool
        """
    ...
    def system_defined(self, system_defined):
        """
        Sets the system_defined of this EdgeLoadBalancerTcpUdpProfile.
        Whether the TCP/UDP profile is system defined.

        :param system_defined: The system_defined of this EdgeLoadBalancerTcpUdpProfile.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, EdgeLoadBalancerTcpUdpProfile):
            return False
