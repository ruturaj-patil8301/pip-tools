...
class NsxVManagerSettings(object):
    """
    ...
    def __init__(self, vc_id=None, network_provider_scope=None, control_vm_resource_pool_vc_path=None, control_vm_datastore_name=None, control_vm_management_interface_name=None):
        """
        NsxVManagerSettings - a model defined in Swagger
        """
    ...
    def vc_id(self):
        """
        Gets the vc_id of this NsxVManagerSettings.
        URN of the associated vCenter server.

        :return: The vc_id of this NsxVManagerSettings.
        :rtype: str
        """
        return self._vc_id
    ...
    def vc_id(self, vc_id):
        """
        Sets the vc_id of this NsxVManagerSettings.
        URN of the associated vCenter server.

        :param vc_id: The vc_id of this NsxVManagerSettings.
        :type: str
        """
        if vc_id is None:
    ...
    def network_provider_scope(self):
        """
        Gets the network_provider_scope of this NsxVManagerSettings.
        Public label of this NSX server visible to all tenants.

        :return: The network_provider_scope of this NsxVManagerSettings.
        :rtype: str
        """
    ...
    def network_provider_scope(self, network_provider_scope):
        """
        Sets the network_provider_scope of this NsxVManagerSettings.
        Public label of this NSX server visible to all tenants.

        :param network_provider_scope: The network_provider_scope of this NsxVManagerSettings.
        :type: str
        """
    ...
    def control_vm_resource_pool_vc_path(self):
        """
        Gets the control_vm_resource_pool_vc_path of this NsxVManagerSettings.
        Path to the resource pool to use for creating Control VM for Cross-VDC Networking.

        :return: The control_vm_resource_pool_vc_path of this NsxVManagerSettings.
        :rtype: str
        """
    ...
    def control_vm_resource_pool_vc_path(self, control_vm_resource_pool_vc_path):
        """
        Sets the control_vm_resource_pool_vc_path of this NsxVManagerSettings.
        Path to the resource pool to use for creating Control VM for Cross-VDC Networking.

        :param control_vm_resource_pool_vc_path: The control_vm_resource_pool_vc_path of this NsxVManagerSettings.
        :type: str
        """
        if control_vm_resource_pool_vc_path is None:
            raise ValueError("Invalid value for `control_vm_resource_pool_vc_path`, must not be `None`")
    ...
    def control_vm_datastore_name(self):
        """
        Gets the control_vm_datastore_name of this NsxVManagerSettings.
        Name of the Datastore to use for creating Control VM for Cross-VDC Networking.

        :return: The control_vm_datastore_name of this NsxVManagerSettings.
        :rtype: str
        """
    ...
    def control_vm_datastore_name(self, control_vm_datastore_name):
        """
        Sets the control_vm_datastore_name of this NsxVManagerSettings.
        Name of the Datastore to use for creating Control VM for Cross-VDC Networking.

        :param control_vm_datastore_name: The control_vm_datastore_name of this NsxVManagerSettings.
        :type: str
        """
        if control_vm_datastore_name is None:
            raise ValueError("Invalid value for `control_vm_datastore_name`, must not be `None`")
    ...
    def control_vm_management_interface_name(self):
        """
        Gets the control_vm_management_interface_name of this NsxVManagerSettings.
        Name of the management interface to use for creating Control VM for Cross-VDC Networking.

        :return: The control_vm_management_interface_name of this NsxVManagerSettings.
        :rtype: str
        """
    ...
    def control_vm_management_interface_name(self, control_vm_management_interface_name):
        """
        Sets the control_vm_management_interface_name of this NsxVManagerSettings.
        Name of the management interface to use for creating Control VM for Cross-VDC Networking.

        :param control_vm_management_interface_name: The control_vm_management_interface_name of this NsxVManagerSettings.
        :type: str
        """
        if control_vm_management_interface_name is None:
            raise ValueError("Invalid value for `control_vm_management_interface_name`, must not be `None`")
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, NsxVManagerSettings):
            return False
