...
class FirewallGroupScope(object):
    ...
    def __init__(self, org_ref=None, edge_gateway_ref=None, owner_ref=None, network_provider_scope=None):
        """
    ...
    def owner_ref(self):
        """
        Gets the owner_ref of this FirewallGroupScope.
        ...
        :return: The owner_ref of this FirewallGroupScope.
        :rtype: EntityReference
        """
    ...
    def owner_ref(self, owner_ref):
        """
        Sets the owner_ref of this FirewallGroupScope.
        The vDC Group or Edge Gateway that this firewall group is scoped to. This group can be used for configuring rules for either an Edge Gateway or vDC Group. If an Edge Gateway is specified that belongs to a vDC Group, the the firewall group will be scoped to the vDC Group. 

        :param owner_ref: The owner_ref of this FirewallGroupScope.
        :type: EntityReference
        """
