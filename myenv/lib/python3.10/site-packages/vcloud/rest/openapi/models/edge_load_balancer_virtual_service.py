...
class EdgeLoadBalancerVirtualService(object):
    """
    ...
    swagger_types = {
        ...
        'application_profile': 'EdgeLoadBalancerApplicationProfile'
    }
    ...
    def status(self):
        """
        Gets the status of this EdgeLoadBalancerVirtualService.
        Represents current status of the networking object. 

        :return: The status of this EdgeLoadBalancerVirtualService.
    ...
    def status(self, status):
        """
        Sets the status of this EdgeLoadBalancerVirtualService.
        Represents current status of the networking object. 

        :param status: The status of this EdgeLoadBalancerVirtualService.
    ...
    def id(self):
        """
        Gets the id of this EdgeLoadBalancerVirtualService.
        The identifier of the Virtual Service in URN format

        :return: The id of this EdgeLoadBalancerVirtualService.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this EdgeLoadBalancerVirtualService.
        The identifier of the Virtual Service in URN format

        :param id: The id of this EdgeLoadBalancerVirtualService.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this EdgeLoadBalancerVirtualService.
        The name of the Virtual Service. Name is unique across all Virtual Services for an Edge Gateway.

        :return: The name of this EdgeLoadBalancerVirtualService.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this EdgeLoadBalancerVirtualService.
        The name of the Virtual Service. Name is unique across all Virtual Services for an Edge Gateway.

        :param name: The name of this EdgeLoadBalancerVirtualService.
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """
        Gets the description of this EdgeLoadBalancerVirtualService.
        The description of the Virtual Service.

        :return: The description of this EdgeLoadBalancerVirtualService.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this EdgeLoadBalancerVirtualService.
        The description of the Virtual Service.

        :param description: The description of this EdgeLoadBalancerVirtualService.
        :type: str
        """
    ...
    def enabled(self):
        """
        Gets the enabled of this EdgeLoadBalancerVirtualService.
        A flag indicating whether Virtual Service is enabled or not.

        :return: The enabled of this EdgeLoadBalancerVirtualService.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """
        Sets the enabled of this EdgeLoadBalancerVirtualService.
        A flag indicating whether Virtual Service is enabled or not.

        :param enabled: The enabled of this EdgeLoadBalancerVirtualService.
        :type: bool
        """
        if enabled is None:
    ...
    def virtual_ip_address(self):
        """
        Gets the virtual_ip_address of this EdgeLoadBalancerVirtualService.
        ...
        :return: The virtual_ip_address of this EdgeLoadBalancerVirtualService.
        :rtype: str
        """
    ...
    def virtual_ip_address(self, virtual_ip_address):
        """
        Sets the virtual_ip_address of this EdgeLoadBalancerVirtualService.
        The virtual IP Address (VIP) of the Virtual Service. This IP can be an allocated IP to the Gateway from the External Network or it can be an arbitrary internal IP address used for internal load balancing. It it's an internal IP Address, this IP cannot be part of any existing subnet attached to the Edge Gateway or any vDC Group network if the Edge Gateway is scoped accordingly. 

        :param virtual_ip_address: The virtual_ip_address of this EdgeLoadBalancerVirtualService.
        :type: str
        """
    ...
    def load_balancer_pool_ref(self):
        """
        Gets the load_balancer_pool_ref of this EdgeLoadBalancerVirtualService.
        The Load Balancer Pool associated with this Virtual Service.

        :return: The load_balancer_pool_ref of this EdgeLoadBalancerVirtualService.
    ...
    def load_balancer_pool_ref(self, load_balancer_pool_ref):
        """
        Sets the load_balancer_pool_ref of this EdgeLoadBalancerVirtualService.
        The Load Balancer Pool associated with this Virtual Service.

        :param load_balancer_pool_ref: The load_balancer_pool_ref of this EdgeLoadBalancerVirtualService.
    ...
    def gateway_ref(self):
        """
        Gets the gateway_ref of this EdgeLoadBalancerVirtualService.
        The Edge Gateway associated with this Virtual Service.

        :return: The gateway_ref of this EdgeLoadBalancerVirtualService.
        :rtype: EntityReference
        """
    ...
    def gateway_ref(self, gateway_ref):
        """
        Sets the gateway_ref of this EdgeLoadBalancerVirtualService.
        The Edge Gateway associated with this Virtual Service.

        :param gateway_ref: The gateway_ref of this EdgeLoadBalancerVirtualService.
        :type: EntityReference
        """
    ...
    def service_engine_group_ref(self):
        """
        Gets the service_engine_group_ref of this EdgeLoadBalancerVirtualService.
        ...
        :return: The service_engine_group_ref of this EdgeLoadBalancerVirtualService.
        :rtype: EntityReference
        """
    ...
    def service_engine_group_ref(self, service_engine_group_ref):
        """
        Sets the service_engine_group_ref of this EdgeLoadBalancerVirtualService.
        The Load Balancer Service Engine Group that is assigned to the Edge Gateway. This Virtual Service will be deployed to this Service Engine Group. 

        :param service_engine_group_ref: The service_engine_group_ref of this EdgeLoadBalancerVirtualService.
        :type: EntityReference
        """
    ...
    def certificate_ref(self):
        """
        Gets the certificate_ref of this EdgeLoadBalancerVirtualService.
        ...
        :return: The certificate_ref of this EdgeLoadBalancerVirtualService.
        :rtype: EntityReference
        """
    ...
    def certificate_ref(self, certificate_ref):
        """
        Sets the certificate_ref of this EdgeLoadBalancerVirtualService.
        The certificate used for SSL termination for the Virtual Service. This is required if the service port type is \"HTTPS\" or \"L4_TLS\".

        :param certificate_ref: The certificate_ref of this EdgeLoadBalancerVirtualService.
        :type: EntityReference
        """
    ...
    def service_ports(self):
        """
        Gets the service_ports of this EdgeLoadBalancerVirtualService.
        ...
        :return: The service_ports of this EdgeLoadBalancerVirtualService.
    ...
    def service_ports(self, service_ports):
        """
        Sets the service_ports of this EdgeLoadBalancerVirtualService.
        A list of service ports supported by this Virtual Service.  Multiple service ports are allowed only with additional licensing. 

        :param service_ports: The service_ports of this EdgeLoadBalancerVirtualService.
    ...
    def health_status(self):
        """
        Gets the health_status of this EdgeLoadBalancerVirtualService.
        ...
        :return: The health_status of this EdgeLoadBalancerVirtualService.
        :rtype: str
        """
    ...
    def health_status(self, health_status):
        """
        Sets the health_status of this EdgeLoadBalancerVirtualService.
        The current health status of the virtual service. Possible values are: <ul> <li> UP - The virtual service is healthy. <li> DOWN - The virtual service is down, inactive, or has failed. <li> DISABLED - The virtual service is disabled. <li> UNAVAILABLE - The virtual service is unavailable. <li> PENDING - The virtual service is being creating or resources are being allocated. <li> UNKNOWN - The virtual service state is unknown. </ul> 

        :param health_status: The health_status of this EdgeLoadBalancerVirtualService.
        :type: str
        """
    ...
    def health_message(self):
        """
        Gets the health_message of this EdgeLoadBalancerVirtualService.
        The localized message on the health of the virtual service.

        :return: The health_message of this EdgeLoadBalancerVirtualService.
        :rtype: str
        """
    ...
    def health_message(self, health_message):
        """
        Sets the health_message of this EdgeLoadBalancerVirtualService.
        The localized message on the health of the virtual service.

        :param health_message: The health_message of this EdgeLoadBalancerVirtualService.
        :type: str
        """
    ...
    def detailed_health_message(self):
        """
        Gets the detailed_health_message of this EdgeLoadBalancerVirtualService.
        The non-localized detailed message on the health of the virtual service.

        :return: The detailed_health_message of this EdgeLoadBalancerVirtualService.
        :rtype: str
        """
    ...
    def detailed_health_message(self, detailed_health_message):
        """
        Sets the detailed_health_message of this EdgeLoadBalancerVirtualService.
        The non-localized detailed message on the health of the virtual service.

        :param detailed_health_message: The detailed_health_message of this EdgeLoadBalancerVirtualService.
        :type: str
        """
    ...
    def application_profile(self):
        """
        Gets the application_profile of this EdgeLoadBalancerVirtualService.
        Specifies the application profile for the virtual service such as whether it's HTTP, HTTPS, or TCP/UDP.

        :return: The application_profile of this EdgeLoadBalancerVirtualService.
        :rtype: EdgeLoadBalancerApplicationProfile
        """
    ...
    def application_profile(self, application_profile):
        """
        Sets the application_profile of this EdgeLoadBalancerVirtualService.
        Specifies the application profile for the virtual service such as whether it's HTTP, HTTPS, or TCP/UDP.

        :param application_profile: The application_profile of this EdgeLoadBalancerVirtualService.
        :type: EdgeLoadBalancerApplicationProfile
        """
        if application_profile is None:
            raise ValueError("Invalid value for `application_profile`, must not be `None`")
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, EdgeLoadBalancerVirtualService):
            return False
