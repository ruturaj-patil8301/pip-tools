...
class ProviderVdcApi(object):
    ...
    def get_all_provider_vd_cs(self, page, page_size, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_all_provider_vd_cs(page, page_size, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_all_provider_vd_cs_with_http_info(page, page_size, **kwargs)
        else:
            (data) = self.get_all_provider_vd_cs_with_http_info(page, page_size, **kwargs)
            return data

    def get_all_provider_vd_cs_with_http_info(self, page, page_size, **kwargs):
        """
        Get all provider VDCs.
        Retrieve a list of all provider VDCs. Results can be filtered by context (_context). Supported contexts are: DVS (_context==dvs-NN;vimServer.id==urn:vcloud:vimserver:uuid) - | Returns all the provider VDCs which are related to the DVS. The VimServer is required for this filtering. External Network (_context==urn:vcloud:network:uuid) - | Returns all the provider VDCs which are related to the external network. Network Pool (_context==urn:vcloud:networkpool:uuid) - | Returns all the provider VDCs which are accessible to the network pool. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_all_provider_vd_cs_with_http_info(page, page_size, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_all_provider_vd_cs" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'page' is set
        if ('page' not in params) or (params['page'] is None):
            raise ValueError("Missing the required parameter `page` when calling `get_all_provider_vd_cs`")
        # verify the required parameter 'page_size' is set
        if ('page_size' not in params) or (params['page_size'] is None):
            raise ValueError("Missing the required parameter `page_size` when calling `get_all_provider_vd_cs`")

        if 'page' in params and params['page'] < 1:
            raise ValueError("Invalid value for parameter `page` when calling `get_all_provider_vd_cs`, must be a value greater than or equal to `1`")
        if 'page_size' in params and params['page_size'] > 128:
            raise ValueError("Invalid value for parameter `page_size` when calling `get_all_provider_vd_cs`, must be a value less than or equal to `128`")
        if 'page_size' in params and params['page_size'] < 0:
            raise ValueError("Invalid value for parameter `page_size` when calling `get_all_provider_vd_cs`, must be a value greater than or equal to `0`")
        ...
        return self.api_client.call_api('/1.0.0/providerVdcs', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_child_resource_pools(self, pvdc_urn, moref, page, page_size, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_child_resource_pools(pvdc_urn, moref, page, page_size, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str pvdc_urn: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_child_resource_pools_with_http_info(pvdc_urn, moref, page, page_size, **kwargs)
        else:
            (data) = self.get_child_resource_pools_with_http_info(pvdc_urn, moref, page, page_size, **kwargs)
            return data

    def get_child_resource_pools_with_http_info(self, pvdc_urn, moref, page, page_size, **kwargs):
        """
        Browse valid root resource pools hierarchy to back a Provider VDC.
        Get list of child resource pools of the specified parent. If a resource pool is ineligible, but is in the response, this means it has children, which are eligible. A resource pool will be ineligible, unless the cluster has an ESXi host on it. The list will be sorted by name, case insensitive. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_child_resource_pools_with_http_info(pvdc_urn, moref, page, page_size, callback=callback_function)
        ...
        all_params = ['pvdc_urn', 'moref', 'page', 'page_size']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'pvdc_urn' is set
        if ('pvdc_urn' not in params) or (params['pvdc_urn'] is None):
            raise ValueError("Missing the required parameter `pvdc_urn` when calling `get_child_resource_pools`")
        ...
        path_params = {}
        if 'pvdc_urn' in params:
            path_params['pvdcUrn'] = params['pvdc_urn']
        if 'moref' in params:
        ...
        return self.api_client.call_api('/1.0.0/providerVdcs/{pvdcUrn}/infra/resourcePools/browse/{moref}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_root_resource_pools(self, pvdc_urn, page, page_size, **kwargs):
        """
        Browse valid root resource pools hierarchy to back a Provider VDC.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_root_resource_pools(pvdc_urn, page, page_size, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_root_resource_pools_with_http_info(pvdc_urn, page, page_size, **kwargs)
        else:
            (data) = self.get_root_resource_pools_with_http_info(pvdc_urn, page, page_size, **kwargs)
            return data

    def get_root_resource_pools_with_http_info(self, pvdc_urn, page, page_size, **kwargs):
        """
        Browse valid root resource pools hierarchy to back a Provider VDC.
        Get a list of all root resource pools. If a resource pool is ineligible, but is in the response, this means it has children, which are eligible. A resource pool will be ineligible, unless the cluster has an ESXi host on it. The list will be sorted by name, case insensitive. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_root_resource_pools_with_http_info(pvdc_urn, page, page_size, callback=callback_function)
        ...
        all_params = ['pvdc_urn', 'page', 'page_size']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'pvdc_urn' is set
        if ('pvdc_urn' not in params) or (params['pvdc_urn'] is None):
            raise ValueError("Missing the required parameter `pvdc_urn` when calling `get_root_resource_pools`")
        # verify the required parameter 'page' is set
        if ('page' not in params) or (params['page'] is None):
        ...
        return self.api_client.call_api('/1.0.0/providerVdcs/{pvdcUrn}/infra/resourcePools/browse/', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
