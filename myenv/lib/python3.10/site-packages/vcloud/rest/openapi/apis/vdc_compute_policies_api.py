...
class VdcComputePoliciesApi(object):
    """
    ...
    def add_vdc_compute_policy_to_vdcs_with_http_info(self, vdc_refs, vdc_compute_policy_id, **kwargs):
        ...
        return self.api_client.call_api('/1.0.0/vdcComputePolicies/{vdcComputePolicyId}/vdcs', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def create_vdc_compute_policy_with_http_info(self, new_vdc_compute_policy_params, **kwargs):
        ...
        return self.api_client.call_api('/1.0.0/vdcComputePolicies', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_vdc_compute_policy_with_http_info(self, vdc_compute_policy_id, **kwargs):
        ...
        return self.api_client.call_api('/1.0.0/vdcComputePolicies/{vdcComputePolicyId}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_vdc_compute_policy_with_http_info(self, vdc_compute_policy_id, **kwargs):
        ...
        return self.api_client.call_api('/1.0.0/vdcComputePolicies/{vdcComputePolicyId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_vdc_compute_policy_vdcs_with_http_info(self, vdc_compute_policy_id, **kwargs):
        ...
        return self.api_client.call_api('/1.0.0/vdcComputePolicies/{vdcComputePolicyId}/vdcs', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_vdc_compute_policy_vms(self, vdc_compute_policy_id, page, page_size, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_vdc_compute_policy_vms(vdc_compute_policy_id, page, page_size, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_vdc_compute_policy_vms_with_http_info(vdc_compute_policy_id, page, page_size, **kwargs)
        else:
            (data) = self.get_vdc_compute_policy_vms_with_http_info(vdc_compute_policy_id, page, page_size, **kwargs)
            return data

    def get_vdc_compute_policy_vms_with_http_info(self, vdc_compute_policy_id, page, page_size, **kwargs):
        """
        Get all VMs associated with this vDC compute policy
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_vdc_compute_policy_vms_with_http_info(vdc_compute_policy_id, page, page_size, callback=callback_function)
        ...
        all_params = ['vdc_compute_policy_id', 'page', 'page_size', 'sort_asc', 'sort_desc']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_vdc_compute_policy_vms" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'vdc_compute_policy_id' is set
        if ('vdc_compute_policy_id' not in params) or (params['vdc_compute_policy_id'] is None):
            raise ValueError("Missing the required parameter `vdc_compute_policy_id` when calling `get_vdc_compute_policy_vms`")
        # verify the required parameter 'page' is set
        if ('page' not in params) or (params['page'] is None):
            raise ValueError("Missing the required parameter `page` when calling `get_vdc_compute_policy_vms`")
        # verify the required parameter 'page_size' is set
        if ('page_size' not in params) or (params['page_size'] is None):
            raise ValueError("Missing the required parameter `page_size` when calling `get_vdc_compute_policy_vms`")

        if 'page' in params and params['page'] < 1:
            raise ValueError("Invalid value for parameter `page` when calling `get_vdc_compute_policy_vms`, must be a value greater than or equal to `1`")
        if 'page_size' in params and params['page_size'] > 128:
            raise ValueError("Invalid value for parameter `page_size` when calling `get_vdc_compute_policy_vms`, must be a value less than or equal to `128`")
        if 'page_size' in params and params['page_size'] < 0:
            raise ValueError("Invalid value for parameter `page_size` when calling `get_vdc_compute_policy_vms`, must be a value greater than or equal to `0`")
        ...
        return self.api_client.call_api('/1.0.0/vdcComputePolicies/{vdcComputePolicyId}/vms', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def query_vdc_compute_policies_with_http_info(self, page, page_size, **kwargs):
        ...
        return self.api_client.call_api('/1.0.0/vdcComputePolicies', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_vdc_compute_policy(self, update_vdc_compute_policy_params, vdc_compute_policy_id, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param VdcComputePolicy update_vdc_compute_policy_params: (required)
        :param str vdc_compute_policy_id: (required)
        :return: VdcComputePolicy
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def update_vdc_compute_policy_with_http_info(self, update_vdc_compute_policy_params, vdc_compute_policy_id, **kwargs):
        ...
        return self.api_client.call_api('/1.0.0/vdcComputePolicies/{vdcComputePolicyId}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
