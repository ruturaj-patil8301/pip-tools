...
class QueryResultAdminOrgNetworkRecordType(QueryResultRecordType):
    ...
    def __init__(self, name=None,org_name=None,network_pool=None,network_pool_name=None,org=None,ip_scope_id=None,is_ip_scope_inherited=None,gateway=None,netmask=None,subnet_prefix_length=None,dns1=None,dns2=None,is_busy=None):
        self._name = None
        self._org_name = None
