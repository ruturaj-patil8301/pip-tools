...
class QueryResultAdminMediaRecordType(QueryResultRecordType):
    ...
    def __init__(self, org=None,owner_name=None,owner=None,is_published=None,name=None,storage_b=None,vdc=None,vdc_name=None,is_vdc_enabled=None,catalog=None,catalog_name=None,catalog_item=None,creation_date=None,is_busy=None,status=None,storage_profile_name=None):
        self._org = None
