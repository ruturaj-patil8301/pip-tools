...
class QueryResultVAppNetworkRecordType(QueryResultRecordType):
    ...
    def __init__(self, name=None,ip_scope_id=None,is_ip_scope_inherited=None,gateway=None,netmask=None,subnet_prefix_length=None,dns1=None,dns2=None,dns_suffix=None,v_app=None,v_app_name=None,is_busy=None):
        self._name = None
