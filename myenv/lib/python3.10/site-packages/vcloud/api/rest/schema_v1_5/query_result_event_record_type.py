...
class QueryResultEventRecordType(QueryResultRecordType):
    ...
    def __init__(self, event_id=None,event_type=None,time_stamp=None,event_status=None,user_name=None,org_name=None,entity_type=None,entity_name=None,description=None,details=None,service_namespace=None,entity=None):
        self._event_id = None
