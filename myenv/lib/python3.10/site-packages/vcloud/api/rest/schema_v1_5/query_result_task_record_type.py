...
class QueryResultTaskRecordType(QueryResultRecordType):
    ...
    def __init__(self, org=None,org_name=None,name=None,operation_full=None,message=None,start_date=None,end_date=None,status=None,progress=None,owner_name=None,object=None,object_type=None,object_name=None,service_namespace=None):
        self._org = None
        self._org_name = None
        self._name = None
