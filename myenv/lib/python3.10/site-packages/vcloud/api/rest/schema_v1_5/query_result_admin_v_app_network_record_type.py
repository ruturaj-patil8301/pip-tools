...
class QueryResultAdminVAppNetworkRecordType(QueryResultRecordType):
    ...
    def __init__(self, name=None,org=None,is_ip_scope_inherited=None,gateway=None,netmask=None,subnet_prefix_length=None,dns1=None,dns2=None,dns_suffix=None,v_app=None,vapp_name=None,is_busy=None):
        self._name = None
        self._org = None
