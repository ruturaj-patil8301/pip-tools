...
class LoadBalancer(Resource):
    ...
    :type frontend_ip_configurations:
     list[~azure.mgmt.network.v2016_12_01.models.FrontendIPConfiguration]
    ...
    :type load_balancing_rules:
     list[~azure.mgmt.network.v2016_12_01.models.LoadBalancingRule]
    :param probes: Collection of probe objects used in the load balancer
    :type probes: list[~azure.mgmt.network.v2016_12_01.models.Probe]
    ...
    :type inbound_nat_pools:
     list[~azure.mgmt.network.v2016_12_01.models.InboundNatPool]
    :param outbound_nat_rules: The outbound NAT rules.
    :type outbound_nat_rules:
     list[~azure.mgmt.network.v2016_12_01.models.OutboundNatRule]
