...
class ApplicationGatewaysOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2017_03_01.models.ApplicationGateway or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2017_03_01.models.ApplicationGateway
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2017_03_01.models.ApplicationGateway]
    ...
    def list_available_waf_rule_sets(
        ...
        :return: ApplicationGatewayAvailableWafRuleSetsResult or
         ClientRawResponse if raw=true
        :rtype:
         ~azure.mgmt.network.v2017_03_01.models.ApplicationGatewayAvailableWafRuleSetsResult
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
