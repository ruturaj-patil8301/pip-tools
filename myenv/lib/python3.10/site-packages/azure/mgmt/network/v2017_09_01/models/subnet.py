...
class Subnet(SubResource):
    ...
    :type route_table: ~azure.mgmt.network.v2017_09_01.models.RouteTable
    :param service_endpoints: An array of service endpoints.
    :type service_endpoints:
     list[~azure.mgmt.network.v2017_09_01.models.ServiceEndpointPropertiesFormat]
    :ivar ip_configurations: Gets an array of references to the network
     interface IP configurations using subnet.
    :vartype ip_configurations:
     list[~azure.mgmt.network.v2017_09_01.models.IPConfiguration]
    ...
    :type resource_navigation_links:
     list[~azure.mgmt.network.v2017_09_01.models.ResourceNavigationLink]
    ...
    def __init__(self, id=None, address_prefix=None, network_security_group=None, route_table=None, service_endpoints=None, resource_navigation_links=None, provisioning_state=None, name=None, etag=None):
