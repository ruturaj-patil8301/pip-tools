...
class ApplicationGatewayBackendHealthHttpSettings(Model):
    ...
    :type backend_http_settings:
     ~azure.mgmt.network.v2017_09_01.models.ApplicationGatewayBackendHttpSettings
    :param servers: List of ApplicationGatewayBackendHealthServer resources.
    :type servers:
     list[~azure.mgmt.network.v2017_09_01.models.ApplicationGatewayBackendHealthServer]
    """
