...
class VirtualNetworksOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2017_06_01.models.VirtualNetwork or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2017_06_01.models.VirtualNetwork]
