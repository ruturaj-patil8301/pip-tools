...
class VirtualNetworksOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2015_06_15.models.VirtualNetwork or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to the create or update virtual
         network operation
        :type parameters:
         ~azure.mgmt.network.v2015_06_15.models.VirtualNetwork
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2015_06_15.models.VirtualNetwork]
