...
class NetworkInterfacesOperations(object):
    ...
    def get_effective_route_table(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2017_11_01.models.EffectiveRouteListResult]
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-11-01"
    ...
    def list_effective_network_security_groups(
        ...
        :return: An instance of AzureOperationPoller that returns
         ...
         raw=true
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2017_11_01.models.EffectiveNetworkSecurityGroupListResult]
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-11-01"
