...
class LoadBalancer(Resource):
    ...
    :type load_balancing_rules:
     list[~azure.mgmt.network.v2017_11_01.models.LoadBalancingRule]
    ...
    :type inbound_nat_pools:
     list[~azure.mgmt.network.v2017_11_01.models.InboundNatPool]
    :param outbound_nat_rules: The outbound NAT rules.
    :type outbound_nat_rules:
     list[~azure.mgmt.network.v2017_11_01.models.OutboundNatRule]
