...
class VirtualNetworkPeeringsOperations(object):
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2016_09_01.models.VirtualNetworkPeering]
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2016_09_01.models.VirtualNetworkPeeringPaged[~azure.mgmt.network.v2016_09_01.models.VirtualNetworkPeering]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
