...
class LoadBalancersOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2016_09_01.models.LoadBalancer or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2016_09_01.models.LoadBalancer]
