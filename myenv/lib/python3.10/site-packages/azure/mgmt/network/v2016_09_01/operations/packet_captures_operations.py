...
class PacketCapturesOperations(object):
    ...
    def get_status(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2016_09_01.models.PacketCaptureQueryStatusResult]
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2016_09_01.models.PacketCaptureResultPaged[~azure.mgmt.network.v2016_09_01.models.PacketCaptureResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
