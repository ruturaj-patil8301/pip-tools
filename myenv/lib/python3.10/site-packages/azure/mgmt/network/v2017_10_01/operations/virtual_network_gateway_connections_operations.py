...
class VirtualNetworkGatewayConnectionsOperations(object):
    ...
    def update_tags(
        ...
        :return: An instance of AzureOperationPoller that returns
         ...
         raw=true
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2017_10_01.models.VirtualNetworkGatewayConnectionListEntity]
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2017_10_01.models.VirtualNetworkGatewayConnectionPaged[~azure.mgmt.network.v2017_10_01.models.VirtualNetworkGatewayConnection]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
